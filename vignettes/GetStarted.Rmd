---
title: "Get started with the bayesian package"
...
function or update the information later on, as done here. Next, we
define a workflow via the `workflows` package, by combining the above defined
data processing recipe and the model plus the actual model formula to be
...
We can use the workflow including the fitted model, for example, for
convenient predictions with new data without having to worry about all
