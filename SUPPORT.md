# Getting help with bayesian

Thanks for using `bayesian`! Before filing an issue, there are a few
...
To be as efficient as possible, development of R packages tends to be
very bursty, so you shouldn’t worry if you don’t get an immediate
